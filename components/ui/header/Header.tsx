...
const Header: React.FC<HeaderProps> = ({ title = '', children }) => {
  ...
  return (
    ...
    <TouchableOpacity onPress={handleProfileSettings} style={styles.profileButton}>
      <Ionicons name="person-circle-outline" size={20} color="rgb(222, 255, 179)" style={{ marginRight: 3 }} />
